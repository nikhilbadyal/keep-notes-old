                  ...
                  if (action == 'delete permanently') {
                    bool value =
                        await Provider.of<NotesHelper>(context, listen: false)
                            .deleteNote(note);
                    if (value) {
                      Utilities.showSnackbar(context, "Note Deleted",
                          Colors.white, Duration(seconds: 1), Colors.green);
                    } else {
                      Utilities.showSnackbar(context, "Some error occurred",
                          Colors.white, Duration(seconds: 1), Colors.redAccent);
                    }
                  } else if (action == 'delete') {
                    await Provider.of<NotesHelper>(context, listen: false)
                        .trashNote(
                            note: note, context: context, fromWhere: fromWhere);
